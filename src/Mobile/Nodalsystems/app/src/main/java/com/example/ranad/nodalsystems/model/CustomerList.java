...
public class CustomerList implements Serializable, Parcelable {
     ...
     * @param mobile
     */
    public CustomerList(int customerId, String firstName, String middleName, String lastName, String customerCode, int amountLimit, String mobile, String email, String address1, String address2, String city, String state, String country, String pin, boolean isActive, int createdById, String createdDate, int lastUpdatedById, String lastUpdatedDate) {
        super();
