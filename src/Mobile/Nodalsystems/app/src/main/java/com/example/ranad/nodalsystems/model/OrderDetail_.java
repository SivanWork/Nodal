...
public class OrderDetail_ implements Serializable, Parcelable
{
    ...
    public final static Creator<OrderDetail_> CREATOR = new Creator<OrderDetail_>() {


        @SuppressWarnings({
            "unchecked"
        })
        public OrderDetail_ createFromParcel(Parcel in) {
            return new OrderDetail_(in);
        }

        public OrderDetail_[] newArray(int size) {
            return (new OrderDetail_[size]);
        }

    }
    ;
    private final static long serialVersionUID = 4506843311320130634L;

    protected OrderDetail_(Parcel in) {
     ...
     */
    public OrderDetail_(int id, int orderId, int productId, int quantity, int cGST, int sGST, int iGST, int discount, int netPrice, int createdById, String createdDate, int lastUpdatedById, String lastUpdatedDate) {
        super();
        this.id = id;
