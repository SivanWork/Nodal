...
public class OrderDetail__ implements Serializable, Parcelable
{
    ...
    public final static Creator<OrderDetail__> CREATOR = new Creator<OrderDetail__>() {


        @SuppressWarnings({
            "unchecked"
        })
        public OrderDetail__ createFromParcel(Parcel in) {
            return new OrderDetail__(in);
        }

        public OrderDetail__[] newArray(int size) {
            return (new OrderDetail__[size]);
        }

    }
    ;
    private final static long serialVersionUID = -1016963150107656889L;

    protected OrderDetail__(Parcel in) {
     ...
     */
    public OrderDetail__(int id, int orderId, int productId, int quantity, int cGST, int sGST, int iGST, int discount, int netPrice, int createdById, String createdDate, int lastUpdatedById, String lastUpdatedDate) {
        super();
        this.id = id;
