...
public class ProductList implements Serializable, Parcelable {
    ...
    private final static long serialVersionUID = 3143829141650346602L;
     ...
     * @param sGST
     */
    public ProductList(int productId, String productName, String productCode, double mRP, double dealerPrice, double wholesalePrice, double cGST, double sGST, double iGST, boolean isActive, int createdById, String createdDate, int lastUpdatedById, String lastUpdatedDate) {
        super();
