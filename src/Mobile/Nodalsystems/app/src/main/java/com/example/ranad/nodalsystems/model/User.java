...
public class User implements Serializable, Parcelable
{
     ...
     */
    public User(int userId, String username, String password, String firstName, String middleName, String lastName, String mobile, String email, String address1, String address2, String city, String state, String country, String pin, String userGroupType, String userElementCode, String activeFrom, String activeTo, boolean isActive, int createdById, String createdDate, int lastUpdatedById, String lastUpdatedDate) {
        super();
        this.userId = userId;
